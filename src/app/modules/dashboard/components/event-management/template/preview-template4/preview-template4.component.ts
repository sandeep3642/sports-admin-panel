...
@Component({
  selector: 'app-preview-template4',
  imports: [CommonModule],
  templateUrl: './preview-template4.component.html',
  styleUrl: './preview-template4.component.css'
})
export class PreviewTemplate4Component {
